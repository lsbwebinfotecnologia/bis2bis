...
return array(
    'ApiFastCommerce' => $baseDir . '/model/ApiFastCommerce.class.php',
    'Assunto' => $baseDir . '/model/Assunto.class.php',
    'Autor' => $baseDir . '/model/Autor.class.php',
    'Carrinho' => $baseDir . '/model/Carrinho.class.php',
    'Categorias' => $baseDir . '/model/Categorias.class.php',
    'ClienteDadosEnderecosSkyhub' => $baseDir . '/model/ClienteDadosEnderecosSkyhub.class.php',
    'ClienteDadosSkyhub' => $baseDir . '/model/ClienteDadosSkyhub.class.php',
    'ClienteERP' => $baseDir . '/model/ClienteERP.class.php',
    'Clientes' => $baseDir . '/model/Clientes.class.php',
    'ClientesAPI' => $baseDir . '/model/ClientesAPI.class.php',
    'ClientesDadosEnderecosAdmin' => $baseDir . '/model/ClientesDadosEnderecosAdmin.class.php',
    'ClientesSkyHub' => $baseDir . '/model/ClientesSkyHub.class.php',
    'Conexao' => $baseDir . '/model/Conexao.class.php',
    'ConexaoSQL' => $baseDir . '/model/ConexaoSQL.class.php',
    'Config' => $baseDir . '/model/Config.class.php',
    'Configuracoes' => $baseDir . '/model/Configuracoes.class.php',
    'Cron' => $baseDir . '/model/Cron.class.php',
    'CronusPedidosSkyhub' => $baseDir . '/model/CronusPedidosSkyhub.class.php',
    'CronusProdutosSkyHub' => $baseDir . '/model/CronusProdutosSkyHub.class.php',
    'DadosAdmin' => $baseDir . '/model/DadosAdmin.class.php',
    'DadosDePara' => $baseDir . '/model/DadosDePara.class.php',
    'DadosLoja' => $baseDir . '/model/DadosLoja.class.php',
    'Editora' => $baseDir . '/model/Editora.class.php',
    'EnderecoCliente' => $baseDir . '/model/EnderecoCliente.class.php',
    'EnderecoClienteERP' => $baseDir . '/model/EnderecoClienteERP.class.php',
    'EnderecoClienteSkyHub' => $baseDir . '/model/EnderecoClienteSkyHub.class.php',
    'EnviarEmail' => $baseDir . '/model/EnviarEmail.class.php',
    'ErosTipoProduto' => $baseDir . '/model/ErosTipoProduto.class.php',
    'Estados' => $baseDir . '/model/Estados.class.php',
    'Estoque' => $baseDir . '/model/Estoque.class.php',
    'EstoqueHorus' => $baseDir . '/model/EstoqueHorus.class.php',
    'EstruturaTabela' => $baseDir . '/model/EstruturaTabela.class.php',
    'EventosCronus' => $baseDir . '/model/EventosCronus.class.php',
    'FTPcs' => $baseDir . '/model/FTPcs.class.php',
    'FilaIntegracao' => $baseDir . '/model/FilaIntegracao.class.php',
    'Functions' => $baseDir . '/model/Functions.class.php',
    'GrupoProduto' => $baseDir . '/model/GrupoProduto.class.php',
    'HSApiHorus' => $baseDir . '/model/HSApiHorus.class.php',
    'HSAutores' => $baseDir . '/model/HSAutores.class.php',
    'HSCategorias' => $baseDir . '/model/HSCategorias.class.php',
    'HSEditoras' => $baseDir . '/model/HSEditoras.class.php',
    'HSEstruturaPametros' => $baseDir . '/model/HSEstruturaPametros.class.php',
    'HSGrupoItem' => $baseDir . '/model/HSGrupoItem.class.php',
    'HSImagemProduto' => $baseDir . '/model/HSImagemProduto.class.php',
    'HSPrecos' => $baseDir . '/model/HSPrecos.class.php',
    'HSProdutosCategoria' => $baseDir . '/model/HSProdutosCategoria.class.php',
    'HSSelos' => $baseDir . '/model/HSSelos.class.php',
    'HSTipoItem' => $baseDir . '/model/HSTipoItem.class.php',
    'HsProdutos' => $baseDir . '/model/HsProdutos.class.php',
    'ItensPedidoCronus' => $baseDir . '/model/ItensPedidoCronus.class.php',
    'Login' => $baseDir . '/model/Login.class.php',
    'LojaIntegradaCategoria' => $baseDir . '/model/LojaIntegradaCategoria.class.php',
    'LojaIntegradaEstoque' => $baseDir . '/model/LojaIntegradaEstoque.class.php',
    'LojaIntegradaMarca' => $baseDir . '/model/LojaIntegradaMarca.class.php',
    'LojaIntegradaPrecos' => $baseDir . '/model/LojaIntegradaPrecos.class.php',
    'LojaIntegradaProdutos' => $baseDir . '/model/LojaIntegradaProdutos.class.php',
    'Municipios' => $baseDir . '/model/Municipios.class.php',
    'Normalizer' => $vendorDir . '/symfony/polyfill-intl-normalizer/Resources/stubs/Normalizer.php',
    'Paginacao' => $baseDir . '/model/Paginacao.class.php',
    'PedidoBD' => $baseDir . '/model/PedidoBD.class.php',
    'Pedidos' => $baseDir . '/model/Pedidos.class.php',
    'PedidosAPI' => $baseDir . '/model/PedidosAPI.class.php',
    'PedidosAtualizarStatus' => $baseDir . '/model/PedidosAtualizarStatus.class.php',
    'PedidosCS' => $baseDir . '/model/PedidosCS.class.php',
    'PedidosCSItens' => $baseDir . '/model/PedidosCSItens.class.php',
    'PedidosCronus' => $baseDir . '/model/PedidosCronus.class.php',
    'PedidosCronuz' => $baseDir . '/model/PedidosCronuz.class.php',
    'PedidosCronuzItens' => $baseDir . '/model/PedidosCronuzItens.class.php',
    'PedidosDash' => $baseDir . '/model/PedidosDash.class.php',
    'PedidosERP' => $baseDir . '/model/PedidosERP.class.php',
    'PedidosItens' => $baseDir . '/model/PedidosItens.class.php',
    'PedidosItensAdmin' => $baseDir . '/model/PedidosItensAdmin.class.php',
    'PedidosItensSkyhub' => $baseDir . '/model/PedidosItensSkyhub.class.php',
    'PedidosLoja' => $baseDir . '/model/PedidosLoja.class.php',
    'PedidosMagento' => $baseDir . '/model/PedidosMagento.class.php',
    'PedidosSkyhub' => $baseDir . '/model/PedidosSkyhub.class.php',
    'PedidosStatus' => $baseDir . '/model/PedidosStatus.class.php',
    'Preco' => $baseDir . '/model/Preco.class.php',
    'Produto' => $baseDir . '/model/Produto.class.php',
    'ProdutoAutor' => $baseDir . '/model/ProdutoAutor.class.php',
    'ProdutoBis2Bis' => $baseDir . '/model/ProdutoBis2Bis.class.php',
    'ProdutoCategoria' => $baseDir . '/model/ProdutoCategoria.class.php',
    'ProdutoDados' => $baseDir . '/model/ProdutoDados.class.php',
    'ProdutoDadosEstoque' => $baseDir . '/model/ProdutoDadosEstoque.class.php',
    'ProdutoEditora' => $baseDir . '/model/ProdutoEditora.class.php',
    'ProdutoManager' => $baseDir . '/model/ProdutoManager.class.php',
    'ProdutoTipo' => $baseDir . '/model/ProdutoTipo.class.php',
    'ProdutoValidacaoDados' => $baseDir . '/model/ProdutoValidacaoDados.class.php',
    'ProdutosAPI' => $baseDir . '/model/ProdutosAPI.class.php',
    'ProdutosAtributos' => $baseDir . '/model/ProdutosAtributos.class.php',
    'ProdutosCronus' => $baseDir . '/model/ProdutosCronus.class.php',
    'ProdutosExcel' => $baseDir . '/model/ProdutosExcel.class.php',
    'ProdutosInfo' => $baseDir . '/model/ProdutosInfo.class.php',
    'ProdutosSendSkyhub' => $baseDir . '/model/ProdutosSendSkyhub.class.php',
    'ProdutosUpdateSkyhub' => $baseDir . '/model/ProdutosUpdateSkyhub.class.php',
    'Projetos' => $baseDir . '/model/Projetos.class.php',
    'ProjetosDados' => $baseDir . '/model/ProjetosDados.class.php',
    'RastreioPedidos' => $baseDir . '/model/RastreioPedidos.class.php',
    'Rotas' => $baseDir . '/model/Rotas.class.php',
    'Sistema' => $baseDir . '/model/Sistema.class.php',
    'SkyHubCategorias' => $baseDir . '/model/SkyHubCategorias.class.php',
    'SkyHubPLP' => $baseDir . '/model/SkyHubPLP.class.php',
    'SkyHubPedido' => $baseDir . '/model/SkyHubPedido.class.php',
    'SkyHubProdutoUpdate' => $baseDir . '/model/SkyHubProdutosUpdate.class.php',
    'SkyHubProdutoValidacao' => $baseDir . '/model/SkyHubProdutoValidacao.class.php',
    'SkyHubProdutos' => $baseDir . '/model/SkyHubProdutos.class.php',
    'SkyhubCall' => $baseDir . '/model/SkyhubCall.class.php',
    'SkyhubEtiquetas' => $baseDir . '/model/SkyhubEtiquetas.class.php',
    'SkyhubPedidosUpdate' => $baseDir . '/model/SkyhubPedidosUpdate.class.php',
    'SkyhubProdutosInfo' => $baseDir . '/model/SkyhubProdutosInfo.class.php',
    ...
    'StatusPedidos' => $baseDir . '/model/StatusPedidos.class.php',
    ...
    'TipoProduto' => $baseDir . '/model/TipoProduto.class.php',
    'TrayBrands' => $baseDir . '/model/TrayBrands.class.php',
    'TrayCaracteristicas' => $baseDir . '/model/TrayCaracteristicas.class.php',
    'TrayCategorias' => $baseDir . '/model/TrayCategorias.class.php',
    'TrayClientes' => $baseDir . '/model/TrayClientes.class.php',
    'TrayConfig' => $baseDir . '/model/TrayConfig.class.php',
    'TrayPedidos' => $baseDir . '/model/TrayPedidos.class.php',
    'TrayPedidosItens' => $baseDir . '/model/TrayPedidosItens.class.php',
    'TrayProdutos' => $baseDir . '/model/TrayProdutos.class.php',
    'TrayToken' => $baseDir . '/model/TrayToken.class.php',
    'Usuarios' => $baseDir . '/model/Usuarios.class.php',
    'WCProdutoCategorias' => $baseDir . '/model/WCProdutoCategorias.class.php',
    'WSHorus' => $baseDir . '/model/WSHorus.class.php',
);
